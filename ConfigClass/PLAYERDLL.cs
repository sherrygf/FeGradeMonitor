...
{  
    ...
    public delegate int fDecCallBackFunction(long nPort, IntPtr pBuf, long nSize, ref FRAME_INFO pFrameInfo, IntPtr pUser, long nReserved2);
    public delegate int fStatusEventCallBack(long nPort, Int32 nStateCode, IntPtr pResponse, IntPtr pUser);
    public delegate int fDisplayFinishCallBack(long lType/*=0x10000001*/, IntPtr lPara1/*==HDC*/, long lPara2/*==NULL*/);//add 20130217 play file by zfuwen


    static public class PLAYERDLL
    {
        ...
        /// <returns></returns>
        [DllImport("DllPlayer.dll")]
        public static extern int IP_TPS_SetFileEndMsgWnd(int nPort, long hWnd, long lMsg);//add 20130217 play file
        ...
        /// <returns></returns>
        [DllImport("DllPlayer.dll")]
        public static extern int IP_TPS_SetColor(int nPort, long lBrightness, long lContrast, long lSaturation, long lHue);//add 20130217 play file by zfuwen
        ...
        /// <returns></returns>
        [DllImport("DllPlayer.dll")]
        public static extern int IP_TPS_GetColor(int nPort, ref long plBrightness, ref long plContrast, ref  long plSaturation, ref  long plHue);//add 20130217 play file by zfuwen
